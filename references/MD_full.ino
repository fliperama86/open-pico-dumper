...
void writeWord_SDA(unsigned long myAddress, word myData)
...
void writeWord_SCL(unsigned long myAddress, word myData)
...
void writeWord_CM(unsigned long myAddress, word myData)
{ // Codemasters
  PORTF = myAddress & 0xFF;
  PORTK = (myAddress >> 8) & 0xFF;
  PORTL = (myAddress >> 16) & 0xFF;
...
void EepromSetDeviceAddress(word addrhi)
{ // 24C02+
  for (int i = 0; i < 3; i++)
  {
...
//******************************************
void writeRealtec(unsigned long address, byte value)
